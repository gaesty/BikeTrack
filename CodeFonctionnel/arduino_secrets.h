...
#define SECRET_SIM_PIN_CODE {PIN_SIM_CARD}
...
#define SECRET_DEVICE_ID {NAME_DEVICE}
...
#define SECRET_PROXY_URL "http://{IP_ADRESS}:3000/proxy"

// Paramètres de connexion décomposés (utilisés par le client TCP)
#define PROXY_HOST {IP_ADRESS}  // Adresse IP ou nom d'hôte du serveur
