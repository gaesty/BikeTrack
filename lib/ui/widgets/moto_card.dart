    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text("Dernière position :", style: Theme.of(context).textTheme.titleLarge),
            ...
            if (status.shockDetected) const Text("⚠️ Choc détecté !", style: TextStyle(color: Colors.red)),
            if (status.tiltDetected) const Text("⚠️ Inclinaison anormale !", style: TextStyle(color: Colors.orange)),
